...
void readimu_func(void* cmd, char* argstr, Stream* stream)
{
    ...
    while (1);
    #else
    stream->printf("[%u] ERROR: IMU is disabled, cannot read\r\n", millis());
    #endif
}
